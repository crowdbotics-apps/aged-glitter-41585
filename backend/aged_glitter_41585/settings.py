"""
Django settings for aged_glitter_41585 project.
...
ROOT_URLCONF = 'aged_glitter_41585.urls'
...
WSGI_APPLICATION = 'aged_glitter_41585.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_glitter_41585 API",
    "DESCRIPTION": "API documentation for aged_glitter_41585 App",
    "VERSION": "v1",
}
